...
class Pintra_Blocks_Loader {
    ...
    private function enqueue_editor_assets( $app, $plugins_dir, $plugins_url ) {
        ...
        \wp_add_inline_script( "pintra-$app-editor", 'window.pintra = window.pintra || {}; window.pintra.env = ' . json_encode( array(
